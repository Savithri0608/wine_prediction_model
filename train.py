...
def parse_args():
    ...
    p.add_argument("--csv", default="data/wine_samples.csv", help="Path to CSV (default: data/wine_samples.csv)")
    p.add_argument("--target", default="alcohol", help="Target column name (default: alcohol)")
...
def main():
    ...
    tracking_uri = os.getenv("MLFLOW_TRACKING_URI", "http://127.0.0.1:7006")
    ...
    DATA_PATH = Path("data") / "wine_samples.csv"
